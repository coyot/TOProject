...
namespace TO_1
{
    public static class TspInstanceConstants
    {
        ...
        public const int HeaRunTime = 2;
        public const int HeaPopulationSize = 2;
        public const int HeaNumberOfMutations = 2;
        public const int HeaNumberOfPreMutations = 2;
        public const int HeaNumberOfRecombinations = 2;
    }
}
